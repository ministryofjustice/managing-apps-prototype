module.exports = function (router, content) {
  ...
  router.post('/staff/general-apps-categories/applications/log/select-app-type', function (req, res) {
    ...
    if (appType == 'cat_00') {
      res.redirect('/staff/general-apps-categories/applications/log/prisoner-details?appName=app_51&appType=cat_00' )
    } 
    else {
      res.redirect('/staff/general-apps-categories/applications/log/select-app-name')
    }
  })

  router.post('/staff/general-apps-categories/applications/log/select-app-name', function (req, res) {
    // Make a variable and give it the value from 'how-many-balls'
